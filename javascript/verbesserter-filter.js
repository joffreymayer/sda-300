const categoryTitle = document.querySelectorAll('.js-category-title'); // Gibt eine Liste ALLER HTML-Elemente mit der Klasse '.category-title'. --> Output: das sind 6 <div>-Elemente, die jeweils die 6 verschiedenen Kategorien enthalten.
